...
$(function(){
  ...
  console.log(products[recipient].title)
  console.log(recipient)
  // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text(products[recipient].title)
  modal.find('.modal-price').text(products[recipient].price)
  modal.find('.modal-desc').text(products[recipient].desc)
  modal.find('.modal-img').text(products[recipient].img)
  modal.find('.modal-body input').val(recipient)
  $(".modal-img").attr("src", products[recipient].img);
})
